...
if len(sys.argv) > 0:
	...
	if AREAID.lower() == "cro":
		...
		alamatURL = "http://172.18.65.42/statusatm/viewbyregionprobooscr.pl?REGID=" + regionID + "&ERROR=EPP_ST&gr=Y"
		...
		alamatURL = "http://172.18.65.42/statusatm/viewbyregionprobooscr.pl?REGID=" + regionID + "&ERROR=EPP_ST&gr=N"
